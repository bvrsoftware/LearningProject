...
public class LoginController {
    ...
    @RequestMapping("/user")
    public CustomUser getUserDetailsAfterLogin(Authentication authentication) {
        List<CustomUser> customers = customerRepository.findByEmail(authentication.getName());
        if (customers.size() > 0) {
